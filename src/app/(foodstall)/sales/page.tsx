...
// Next.js is detecting this page at a path that conflicts with your main app's /sales (if any)
// or the intended /foodstall/sales.
//
...
export default function ConflictingFoodstallSalesPage() {
