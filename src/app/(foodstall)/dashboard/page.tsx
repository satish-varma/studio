...
// Next.js is detecting this page at a path that conflicts with your main app's /dashboard
// or the intended /foodstall/dashboard.
//
...
export default function ConflictingFoodstallDashboardPage() {
