      ...
      {selectedStaffUids.length > 0 && (
        <div className="p-3 bg-primary/10 border border-primary/20 rounded-md flex flex-col md:flex-row items-center gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
                ...
                <Button size="sm" variant="outline" className="bg-green-50 text-green-800 border-green-200 hover:bg-green-100" onClick={() => handleBulkUpdate('Present')} disabled={isBulkUpdating}>Mark Present</Button>
