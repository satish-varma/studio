  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <CardContent className="flex flex-col md:flex-row items-stretch md:items-center gap-4 border-t pt-4">
          ...
          <div className="flex-grow flex flex-col sm:flex-row gap-2 justify-end">
            {user?.role === 'admin' && (
                <Select value={siteFilter} onValueChange={setSiteFilter}>
                    <SelectTrigger className="w-full sm:w-[180px] bg-input"><Building className="mr-2 h-4 w-4 text-muted-foreground" /><SelectValue placeholder="Filter by site" /></SelectTrigger>
             ...
             <Select value={vendorFilter} onValueChange={setVendorFilter}>
              <SelectTrigger className="w-full sm:w-[180px] bg-input"><ShoppingCart className="mr-2 h-4 w-4 text-muted-foreground" /><SelectValue placeholder="Filter by vendor" /></SelectTrigger>
            ...
            <Select value={categoryFilter} onValueChange={setCategoryFilter}>
              <SelectTrigger className="w-full sm:w-[180px] bg-input"><ListFilter className="mr-2 h-4 w-4 text-muted-foreground" /><SelectValue placeholder="Filter by category" /></SelectTrigger>
            ...
            <Select value={userFilter} onValueChange={setUserFilter}>
              <SelectTrigger className="w-full sm:w-[180px] bg-input"><Users className="mr-2 h-4 w-4 text-muted-foreground" /><SelectValue placeholder="Filter by user" /></SelectTrigger>
